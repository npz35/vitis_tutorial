...
# Please refer to https://github.com/ros-acceleration/acceleration_examples/blob/7852c02dc46b4d0f5b3622f77214702d8c7d1f25/graphs/perception/perception_2nodes/launch/analyse_rectify_resize.launch.py#L1276https://github.com/ros-acceleration/acceleration_examples/blob/7852c02dc46b4d0f5b3622f77214702d8c7d1f25/graphs/perception/perception_2nodes/launch/analyse_rectify_resize.launch.py
...
def msgsets_from_trace_concurrent(tracename, endorder=9):
    ...
    for trace in image_pipeline_msgs:
        ...
        if trace.event.name == target_chain[0]:
            ...
            pass
    print("Events included : {}".format(keys))
    return image_pipeline_msg_sets
...
print("len(image_pipeline_msg_sets_ms_cpu) : {}".format(len(image_pipeline_msg_sets_ms_cpu)))
...
print("len(image_pipeline_msg_sets_ms_fpga) : {}".format(len(image_pipeline_msg_sets_ms_fpga)))
...
print("len(image_pipeline_msg_sets_ms_fpga_integrated) : {}".format(len(image_pipeline_msg_sets_ms_fpga_integrated)))
...
print("len(image_pipeline_msg_sets_ms_fpga_streamlined) : {}".format(len(image_pipeline_msg_sets_ms_fpga_streamlined)))
# fix data of "*_integrated" to align with dimensions of the rest
...
print("len(image_pipeline_msg_sets_ms_cpu[0]) : {}".format(len(image_pipeline_msg_sets_ms_cpu[0])))
print("len(image_pipeline_msg_sets_ms_fpga[0]) : {}".format(len(image_pipeline_msg_sets_ms_fpga[0])))
print("len(image_pipeline_msg_sets_ms_fpga_integrated[0]) : {}".format(len(image_pipeline_msg_sets_ms_fpga_integrated[0])))
print("len(image_pipeline_msg_sets_ms_fpga_streamlined[0]) : {}".format(len(image_pipeline_msg_sets_ms_fpga_streamlined[0])))
